...
public class PackingController {
	...
	@ApiOperation(value = "패킹 데이터 조회 API", notes =
	...
	@ApiOperation(value = "패킹 상태 변경 API", notes = "status: PRE_PROGRESS(패킹 진행 전) / IN_PROGRESS(패킹 진행 중) / DONE(패킹 진행 완료), HOLD(패킹 진행 보류)")
